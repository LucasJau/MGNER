from cls_model.data_utils import CoNLLDataset
from cls_model.ner_model import NERModel
from cls_model.config import Config
...
def main():
    ...
    #cls_model.evaluate(test, config.test_total_entity)
